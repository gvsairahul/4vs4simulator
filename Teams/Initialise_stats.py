...
data =  pd.read_csv(master,usecols=['PLAYERS' , 'Draft3_Player_id','Bowler Style'])
data1 = pd.read_csv(mapping)
data = data[data['Draft3_Player_id'] > 1]
data2 = pd.merge(data,data1,how = 'left',left_on = 'Draft3_Player_id',right_on = 'Player_id')
print(data2)
imp = ['PLAYERS' , 'Name' , 'Bowler Style']
data2 =  data2[imp]
...
data2 = data2[(data2['Bowler Style'] == 'Pace') | (data2['Bowler Style'] == 'Spin')]
