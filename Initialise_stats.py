...
data =  pd.read_csv(master,usecols=['PLAYERS' , 'Minidraft3','Bowler Style'])
data1 = pd.read_csv(mapping)
data = data[data['Minidraft3'] > 1]
data2 = pd.merge(data,data1,how = 'left',left_on = 'Minidraft3',right_on = 'Player_id')
print(data2)
