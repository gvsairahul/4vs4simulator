...
def ball_result(balls,sit,sit_rate,sit_wkt,batsman,bowler,target,team_wickets,team_score):
    if target == 1800:
        chase = 0
    else:
        chase = 1
    sit1 = situation_calculator(team_score,team_wickets,chase,balls,target)
    result = result_calculator(batsman,bowler,sit,sit_rate,sit_wkt,sit1)
    return result
